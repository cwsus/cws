...
public class ContactValidator implements Validator
{
    ...
    private static final String CNAME = ContactValidator.class.getName();
    ...
    {
        this.methodName = ContactValidator.CNAME + "#supports(final Class clazz)";
    ...
    {
        this.methodName = ContactValidator.CNAME + "#validate(final <Class> request)";
